...
> **Informational mapping. Not legal advice. ISNAD produces evidence
> artifacts; it does not certify compliance.**
>
...
| `source_documents[].uri`, `content_hash` | Annex IV training-data documentation | A.7.2 data quality | MAP (data provenance) | data governance |
| `environment.isnad_version`, `python_version` | Art. 12 (system identity) | A.8.1 configuration management | GOVERN (reproducibility) | transparency |
| `environment.host_fingerprint` | Art. 12 (deployment traceability) | A.8.1 | MANAGE (incident location) | risk management |
