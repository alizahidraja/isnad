...
NARRATORS: dict[str, Narrator] = {
    ...
    "source:openstax-vol3": Narrator(
        "source:openstax-vol3", "source", "reliable",
        upstream_source="openstax.org"),
    "source:crowell-light-matter": Narrator(
        "source:crowell-light-matter", "source", "reliable",
        upstream_source="lightandmatter.com"),
    # Scrapers
    ...
    # Ingest models
    "ingest@good": Narrator("ingest@good", "model", "acceptable",
                            model_family="ingest-good"),
    "ingest@excellent": Narrator("ingest@excellent", "model", "reliable",
                                 model_family="ingest-excellent"),
    "ingest@weak": Narrator("ingest@weak", "model", "rejected",
                            model_family="ingest-weak"),
}
