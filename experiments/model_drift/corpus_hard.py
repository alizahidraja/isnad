...
HARD_CORPUS: tuple[HardFact, ...] = (
    ...
    # --- post-cutoff (2026 events after the model's ~mid-2026 cutoff: drift expected) ---
    HardFact(
        "pc01",
        "What is the men's 400m hurdles world record in seconds?",
        "The men's 400m hurdles world record is 45.80 seconds.",
        "45.80",
        ("45.94", "46.00", "45.00"),
        "sports",
        "postcutoff",
    ...
    HardFact(
        "pc02",
        "What is the women's 100m hurdles world record in seconds?",
        "The women's 100m hurdles world record is 12.09 seconds.",
        "12.09",
        ("12.12", "12.20", "12.00"),
        "sports",
        "postcutoff",
    ...
    HardFact(
        "pc03",
        "What is the men's pole vault world record in meters?",
        "The men's pole vault world record is 6.31 meters.",
        "6.31",
        ("6.26", "6.25", "6.30"),
        "sports",
        "postcutoff",
    ...
    HardFact(
        "pc04",
        "In what year did the New York Knicks win their most recent NBA championship?",
    ...
    HardFact(
        "pc05",
        "In what year did Spain win their most recent FIFA World Cup title?",
        "Spain won the FIFA World Cup in 2026.",
        "2026",
        ("2010", "2022", "2018"),
        "sports",
        "postcutoff",
    ...
    HardFact(
        "pc06",
        "How many total medals did Norway win at the 2026 Winter Olympics?",
        "Norway won 41 total medals at the 2026 Winter Olympics.",
        "41",
        ("35", "37", "30"),
        "sports",
        "postcutoff",
    ...
    HardFact(
        "pc07",
        "How many total medals did the United States win at the 2026 Winter Olympics?",
        "The United States won 33 total medals at the 2026 Winter Olympics.",
        "33",
        ("30", "36", "28"),
        "sports",
        "postcutoff",
    ...
    HardFact(
        "pc08",
        "How many total medals did Italy win at the 2026 Winter Olympics?",
